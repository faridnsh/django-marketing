...
- Siloed teams, missing CI/CD, weak onboarding, and undocumented systems create client and supplier bottlenecks; a Six Feet Up client case reported these issues across more than 30 sub-organizations.
...
An interactive rapid-review study with practitioners organized large-scale software selection across market strength, strategy/culture, productivity, quality, integration, cost, legal, ethics, and sense of control; it also notes performance, compatibility, reliability, security, maintainability, and portability ([Badampudi et al., Journal of Systems and Software](https://doi.org/10.1016/j.jss.2022.111503), 2023). **Direct selection-framework evidence; Medium confidence for agency web-framework choices** because the case concerned engineering software in one large company.
...
| Software selection is multi-criteria, including quality, integration, cost, legal, strategy/culture, ethics, and control—not popularity alone. | [“Software selection in large-scale software engineering”](https://doi.org/10.1016/j.jss.2022.111503), Badampudi et al., *Journal of Systems and Software*, 2023 | Interactive rapid reviews and practitioner co-design/evaluation | Direct model; inferred agency applicability | Medium | One industrial engineering-tool context; useful taxonomy, not Django ranking. |
